...
// console.log('--------VueSwiperSSR', VueSwiperSSR)

describe('vue-awesome-swiper', () => {

  Vue.use(VueSwiper)
  Vue.use(VueSwiperSSR)
  ...
  it('can get the object in es module', () => {
    ...
    expect(typeof VueSwiperSSR.swiper).to.deep.equal('object')
    expect(typeof VueSwiperSSR.install).to.deep.equal('function')
  })
    ...
    it(' - should work', done => {
      ...
      const vm = new Vue({
        template: `<div>
                  ...
                  `,
        components: {
          'LocalSwiper': VueSwiper.swiper,
          'LocalSlide': VueSwiper.swiperSlide,
        },
        data: {
          swiperOption: {
            navigation: {
